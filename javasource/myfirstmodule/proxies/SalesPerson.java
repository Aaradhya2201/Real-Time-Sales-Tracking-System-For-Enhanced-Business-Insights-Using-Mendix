...
public class SalesPerson
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MyFirstModule.SalesPerson"));
	}
	...
	protected SalesPerson(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject salesPersonMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MyFirstModule.SalesPerson", salesPersonMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MyFirstModule.SalesPerson");
	...
	/**
	 * @deprecated Use 'SalesPerson.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static myfirstmodule.proxies.SalesPerson initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return myfirstmodule.proxies.SalesPerson.load(context, mendixIdentifier);
	}
	...
	{
		java.util.List<myfirstmodule.proxies.SalesPerson> result = new java.util.ArrayList<myfirstmodule.proxies.SalesPerson>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//MyFirstModule.SalesPerson" + xpathConstraint))
			result.add(myfirstmodule.proxies.SalesPerson.initialize(context, obj));
		return result;
	}
	...
	{
		return "MyFirstModule.SalesPerson";
	}
