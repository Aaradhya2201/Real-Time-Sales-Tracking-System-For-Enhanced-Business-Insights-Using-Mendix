...
public class Products
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MyFirstModule.Products"));
	}
	...
	protected Products(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject productsMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MyFirstModule.Products", productsMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MyFirstModule.Products");
	...
	public static myfirstmodule.proxies.Products initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return myfirstmodule.proxies.Products.load(context, mendixIdentifier);
	}
	...
	{
		java.util.List<myfirstmodule.proxies.Products> result = new java.util.ArrayList<myfirstmodule.proxies.Products>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//MyFirstModule.Products" + xpathConstraint))
